...
motornode.pdo.rx[2]['Profile deceleration'].raw = 20
motornode.pdo.rx[2]['Profile acceleration'].raw = 20
motornode.pdo.rx[1]['Target position'].raw = 180
motornode.pdo.rx[1]['Profile velocity in pp-mode'].raw = 2000
